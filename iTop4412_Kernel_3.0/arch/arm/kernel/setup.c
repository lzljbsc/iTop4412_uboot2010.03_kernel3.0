...
//Robin:add the cpu_id info to cpuinfo
//Android can get the cpu_id info,and display in the ui
...
extern unsigned char *ts_fw_version;
...
static int c_show(struct seq_file *m, void *v)
{
	...
	/* wenpin.cui: report TS FW Version here */
	seq_printf(m, "TS FW Version\t: %s\n", ts_fw_version);
#endif
