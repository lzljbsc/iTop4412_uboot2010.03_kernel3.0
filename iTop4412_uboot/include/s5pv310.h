...
#ifndef __S5PV310_H__
#define __S5PV310_H__

#ifndef CONFIG_S5PV310
#define CONFIG_S5PV310		1
#endif

#define S5PV31X_UART_CHANNELS		3
#define S5PV31X_SPI_CHANNELS		2
...
#ifndef __ASSEMBLY__
static inline S5PV31X_MEMCTL * S5PV31X_GetBase_MEMCTL(void)
{
	return (S5PV31X_MEMCTL *)(APB_DMC_0_BASE);
}
static inline S5PV31X_USB_HOST * S5PV31X_GetBase_USB_HOST(void)
{
	return (S5PV31X_USB_HOST *)ELFIN_USB_HOST_BASE;
}
static inline S5PV31X_INTERRUPT * S5PV31X_GetBase_INTERRUPT(void)
{
	return (S5PV31X_INTERRUPT *)ELFIN_VIC0_BASE_ADDR;
}
static inline S5PV31X_DMAS * S5PV31X_GetBase_DMAS(void)
{
	return (S5PV31X_DMAS *)ELFIN_DMA_BASE;
}
static inline S5PV31X_CLOCK_POWER * S5PV31X_GetBase_CLOCK_POWER(void)
{
	return (S5PV31X_CLOCK_POWER *)ELFIN_CLOCK_POWER_BASE;
}
static inline S5PV31X_LCD * S5PV31X_GetBase_LCD(void)
{
	return (S5PV31X_LCD *)ELFIN_LCD_BASE;
}
static inline S5PV31X_UART * S5PV31X_GetBase_UART(S5PV31X_UARTS_NR nr)
{
	return (S5PV31X_UART *)(ELFIN_UART_BASE + (nr*0x10000));
}
static inline S5PV31X_TIMERS * S5PV31X_GetBase_TIMERS(void)
{
	return (S5PV31X_TIMERS *)ELFIN_TIMER_BASE;
}
static inline S5PV31X_WATCHDOG * S5PV31X_GetBase_WATCHDOG(void)
{
	return (S5PV31X_WATCHDOG *)ELFIN_WATCHDOG_BASE;
}
static inline S5PV31X_I2C * S5PV31X_GetBase_I2C(void)
{
	return (S5PV31X_I2C *)ELFIN_I2C_BASE;
}
static inline S5PV31X_I2S * S5PV31X_GetBase_I2S(void)
{
	return (S5PV31X_I2S *)ELFIN_I2S_BASE;
}
static inline S5PV31X_GPIO * S5PV31X_GetBase_GPIO(void)
{
	return (S5PV31X_GPIO *)ELFIN_GPIO_BASE;
}
static inline S3C2410_ADC * S3C2410_GetBase_ADC(void)
{
	return (S3C2410_ADC *)ELFIN_ADC_BASE;
}
static inline S5PV31X_SPI * S5PV31X_GetBase_SPI(void)
{
	return (S5PV31X_SPI *)ELFIN_SPI_BASE;
}
